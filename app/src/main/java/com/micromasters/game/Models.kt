...
object Defs {
    ...
    val UNITS = listOf(
        UnitDef("miner", R.string.unit_miner, "🐜", baseProd = 0.5, baseCost = 15.0),
        UnitDef("carrier", R.string.unit_carrier, "📦", baseProd = 2.4, baseCost = 130.0),
        UnitDef("guard", R.string.unit_guard, "🛡", baseProd = 9.0, baseCost = 1000.0),
    ...
    val BOOSTS = listOf(
        BoostDef("x2", R.string.boost_2x, R.string.boost_2x_desc, "⚡", BoostKind.MULTIPLIER, gemCost = 15, durationMs = 15 * 60_000L, multiplier = 2.0),
    ...
    val WORLDS = listOf(
        WorldDef(
            ...
            prodMult = 1.0, baseCap = 220.0, territoryBaseCost = 320.0,
            unlockGems = 0, unlockedByDefault = true, clearReward = 60,
        ...
        WorldDef(
            ...
            unlockGems = 0, unlockedByDefault = true, clearReward = 120,
        ...
        WorldDef(
            ...
            prodMult = 42.0, baseCap = 13000.0, territoryBaseCost = 19000.0,
            unlockGems = 150, unlockedByDefault = false, clearReward = 300,
        ...
        WorldDef(
            ...
            unlockGems = 500, unlockedByDefault = false, clearReward = 800,
